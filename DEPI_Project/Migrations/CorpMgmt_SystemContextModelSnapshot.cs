...
namespace DEPI_Project.Migrations
{
    ...
    partial class CorpMgmt_SystemContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DEPI_Project.Models.CorpMgmt_System.AssignedEmployees", b =>
                {
                    ...
                    b.ToTable("AssignedEmployees", (string)null);
                });
            ...
            modelBuilder.Entity("DEPI_Project.Models.CorpMgmt_System.Employee", b =>
                {
                    ...
                    b.Property<int?>("ManagedDepartmentDepartmentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ManagedDepartmentDepartmentId");
            ...
            modelBuilder.Entity("DEPI_Project.Models.CorpMgmt_System.Employee", b =>
                {
                    ...
                    b.HasOne("DEPI_Project.Models.CorpMgmt_System.Department", "ManagedDepartment")
                        .WithMany()
                        .HasForeignKey("ManagedDepartmentDepartmentId");
